          ...
          <>
            <form onSubmit={handleSubmit}>
              <FormControl id="sampleType" mb={4}>
                ...
                <Select placeholder="Select option" value={form.sampleType} onChange={(e) => setForm({ ...form, sampleType: e.target.value })}>
              ...
              <FormControl id="colors" mb={4}>
                ...
                <CheckboxGroup colorScheme="green" value={form.colors} onChange={(value) => setForm({ ...form, colors: value })}>
                  <Stack spacing={[1, 5]} direction={["column", "row"]}>
                    ...
                    <Checkbox value="Violet">Violet</Checkbox>
                  </Stack>
                </CheckboxGroup>
              </FormControl>
